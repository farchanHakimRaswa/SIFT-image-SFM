#############################################################################
# Makefile for building: Watch
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  Watch.pro
# Template: app
# Command: /usr/lib/i386-linux-gnu/qt5/bin/qmake -o Makefile Watch.pro
#############################################################################
...
INCPATH       = -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I. -I/usr/local/include/opencv -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -I/usr/include/eigen3 -L/usr/local/lib -I/usr/include/opencv -lopencv_core -lopencv_highgui -lopencv_imgproc -lopencv_features2d -lopencv_calib3d -lopencv_imgcodecs -lgtsam -lboost_system -ltbb -lQt5Widgets -L/usr/lib/i386-linux-gnu -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: Watch.pro /usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/i386-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/i386-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/Watch1.0.0 || mkdir -p .tmp/Watch1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Watch1.0.0/ && $(COPY_FILE) --parents mainwindow.h imagedir.h sfm.h .tmp/Watch1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp imagedir.cpp sfm.cpp .tmp/Watch1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/Watch1.0.0/ && (cd `dirname .tmp/Watch1.0.0` && $(TAR) Watch1.0.0.tar Watch1.0.0 && $(COMPRESS) Watch1.0.0.tar) && $(MOVE) `dirname .tmp/Watch1.0.0`/Watch1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Watch1.0.0
...
imagedir.o: imagedir.cpp imagedir.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o imagedir.o imagedir.cpp

sfm.o: sfm.cpp sfm.h \
		imagedir.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o sfm.o sfm.cpp
